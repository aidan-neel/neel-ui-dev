  ...
  variants: {
    variant: {
		...
		secondary:
			...
			"secondary-disabled": "bg-secondary-disabled text-foreground-disabled",
		...
		"outlined-disabled":
      	...
      	ghost:
        	"bg-transparent hover:text-ghost-foreground shadow-none hover:bg-ghost-hovered active:bg-ghost-active text-foreground focus:bg-secondary/30",
      	"ghost-disabled": 
			"bg-transparent text-foreground-disabled",
		...
		barebones: "bg-transparent active:bg-transparent hover:bg-transparent focus:bg-transparent text-foreground",
